...
export default function Home() {
  return (
    <> 
      <section className="relative w-full h-[100lvh] flex items-center justify-center z-10">
        ...
        <div className="relative w-150 h-40">
          <Image alt="Background image" src={"/homeTitle.png"} fill={true}></Image>
        </div>
        <nav className="absolute top-0 left-0 h-16 w-full bg-[#141415d0] flex items-center justify-center">
          ...
          <div className="flex flex-row gap-6">
            <button className="font-rajdhani-sans text-2xl text-white">Menu</button>
            <button className="font-rajdhani-sans text-2xl text-white">Sul bar</button>
            <button className="font-rajdhani-sans text-2xl text-white">Su di noi</button>
          </div>
        </nav>
